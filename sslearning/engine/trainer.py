...
from ..util.misc import ssl_loss
        ...
        for iteration, (images, targets) in enumerate(data_loader):
            ...
            if cfg.TRAIN.HYBRID_PRECISION:
                ...
                with autocast():
                    ...
                    if cfg.SSL.SPARSITY_REGULARIZATION:
                        loss += ssl_loss(model,
                                         model_type=cfg.MODEL.RECOGNIZER.NAME,
                                         loss_type=cfg.SSL.TYPE,
                                         lambda_n=cfg.SSL.LAMBDA_N,
                                         lambda_c=cfg.SSL.LAMBDA_C,
                                         lambda_s=cfg.SSL.LAMBDA_S,
                                         lambda_d=cfg.SSL.LAMBDA_D
                                         )
